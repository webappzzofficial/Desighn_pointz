...
export const categories: Category[] = [
  ...
  },
  {
    ...
    isActive: true,
    sortOrder: 4,
    description: "Premium invitations with floral, classic, luxury, and custom print finishes."
  }
];
...
export const products: Product[] = [
  {
    ...
    description:
      "A premium branded gift bundle for teams, launches, conferences, and client appreciation. Includes print-ready personalization and finish consultation.",
  ...
  },
  {
    ...
    shortDescription: "Premium plaques, trophies, shields, and acrylic awards.",
    price: 1499,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    description:
      "A refined invitation suite with envelope, insert card, floral theme, and optional foil-style premium print finish.",
  ...
  },
  {
    ...
    description:
      "A premium invitation presentation format for special events, with layered inserts and custom packaging choices.",
    shortDescription: "High-end invitation box concepts for premium ceremonies.",
    price: 220,
    isActive: true,
    isFeatured: true,
...
export const siteSettings: SiteSettings = {
  ...
  email: "hello@designpoint.example",
  ...
  metaDescription: "Premium printing, gifting, ID cards, mementos, trophies, and wedding cards.",
  metaKeywords: "printing, gifts, id cards, trophies, wedding cards",
  ogTitle: "Design Point Product Showcase",
  ogDescription: "Explore premium print and gifting products and enquire on WhatsApp.",
